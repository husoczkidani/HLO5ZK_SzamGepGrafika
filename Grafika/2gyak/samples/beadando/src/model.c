...
void init_entities(World *world)
{
    ...
    init_object(&world->trophy1, 400, 170, 0);

    // Trophy2
    load_model("models//trophyobjectfile.obj", &world->trophy2.model);
    world->trophy2.texture = load_texture("textures//trophy.png");
    init_object(&world->trophy2, -120, 170, 0);
    */


    //cactus
    load_model("models//aloe.obj", &world->cactus1.model);
    world->cactus1.texture = load_texture("textures//polydesert_atlas.png");
    init_object(&world->cactus1, 0, 0, 0);


    // Room
    world->room.ground = load_texture("textures//flooor.png");
    world->room.back = load_texture("textures//walll.png");
    world->room.front = load_texture("textures//walll.png");
    world->room.left = load_texture("textures//walll.png");
    world->room.right = load_texture("textures//walll.png");
    world->room.top = load_texture("textures//ceilingg.png");

    // Help
    world->helpTexture = load_texture("textures//guide.png");
